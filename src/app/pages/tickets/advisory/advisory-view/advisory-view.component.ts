...
@Component({
  selector: 'app-advisory-view',
  templateUrl: './advisory-view.component.html',
  styleUrls: ['./advisory-view.component.scss']
})
export class AdvisoryViewComponent implements OnInit {
