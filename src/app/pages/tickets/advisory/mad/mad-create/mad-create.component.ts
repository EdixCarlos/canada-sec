...
@Component({
  selector: 'app-mad-create',
  templateUrl: './mad-create.component.html',
  styleUrls: ['./mad-create.component.scss']
})
export class MadCreateComponent implements OnInit {
  ...
  public ticketType = TicketType[8];
