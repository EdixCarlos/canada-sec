...
@Component({
  selector: 'app-sapr-create',
  templateUrl: './sapr-create.component.html',
  styleUrls: ['./sapr-create.component.scss']
})
export class SaprCreateComponent implements OnInit {
  ...
  public ticketType = TicketType[10];
  ...
  createForm() {
    this.formGroup = this.fb.group({
      ...
      requestArea: [''],
      requestType: [''],
      requestTypeName: ['Security Artifacts Peer Reviews'],
