...
@Component({
  selector: 'app-fpr-create',
  templateUrl: './fpr-create.component.html',
  styleUrls: ['./fpr-create.component.scss']
})
export class FprCreateComponent implements OnInit {
  ...
  public ticketType = TicketType[11];
  ...
  checkObservable() {
    ...
    this.activatedRoute.url.subscribe((url: UrlSegment[]) => {
      if (url[1].path === 'view') {
        ...
        this.formControls.requireType.setValue(this.ticketType.id);
