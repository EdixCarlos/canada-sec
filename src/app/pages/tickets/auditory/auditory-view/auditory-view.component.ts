...
@Component({
  selector: 'app-auditory-view',
  templateUrl: './auditory-view.component.html',
  styleUrls: ['./auditory-view.component.scss']
})
export class AuditoryViewComponent implements OnInit {
